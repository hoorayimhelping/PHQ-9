...
<html lang="en">
<head>
    <title>Code coverage report for git-guppy/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">git-guppy/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">git-guppy/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!hook.stream) {
<span class="cstat-no" title="statement not covered" >        throw new Error('Hook not streamable: ' + name);</span>
      }
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue May 12 2015 21:09:23 GMT-0700 (MST)</div>
</div>
