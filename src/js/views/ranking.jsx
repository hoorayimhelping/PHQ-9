        ...
        return (
            <fieldset>
                <ul>
                    ...
                    <li><input defaultChecked name={this.props.name} id={ids[0]} type="radio" onChange={this.props.onChange} value="0" /><label htmlFor={ids[0]} style={{backgroundColor: 'hsla(126, 18%, 70%, 1)'}}>Not at all</label></li>
